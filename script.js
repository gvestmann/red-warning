...
.then(data =>{
    ...
    if(checked != 'on') {
        ...
        temperature.innerHTML = ~~data[700].AT.av  + '<span class="temperature__measurement"> °c</span>';
        // ... and here's the wind
        wind.innerHTML = ~~data[700].HWS.av  + '<span class="wind__measurement"> m/s</span>';
    // Now, if the user wants farenheit ...
    } else {
        // ... I get the temperature provided by the API and store it in a variable for conversion 
        let celcius = data[700].AT.av
